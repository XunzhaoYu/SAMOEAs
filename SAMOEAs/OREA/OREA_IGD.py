...
# --- OREA ---
from SAMOEAs.OREA.reference_vector import generate_vectors
from SAMOEAs.OREA.labeling_operator import domination_based_ordinal_values
...
class OREA:
    ...
    def run(self, current_iteration):
        ...
        while self.archive_size < self.EVALUATION_MAX:
            ...
            self.new_objs = self._population_evaluation(self.new_point, False, self.upperbound, self.lowerbound)
